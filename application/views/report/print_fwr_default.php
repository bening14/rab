            ...
            <div class="lembar">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        <div class="row">
                            <div class="col-xs-3">
                                <h6 style="border: 1px solid black;padding: 5px;text-align: center;font-size: 10px;">FA Form 07</h6>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-2">
                            ...
                            <div class="col-xs-10">
                                <?php
                                echo '<p>: JAI/MTC/WTS/VI/22/01-6</p>';
                                echo '<p>: 22-JUN-2023</p>';
                    ...
                    <div class="col-xs-6">
                        <table border="1" style="width: 100%;" class="text-center">
                            ...
                            <tr>
                                <!-- <td style="border: 1px solid white">&nbsp;</td> -->
                                <td style="text-align: left;">President Director</td>
                                <td style="text-align: left;">Exim SPV</td>
                                <td style="text-align: left;">FA SPV</td>
                                <td style="text-align: left;">Dept Head PIC</td>
                                <td style="text-align: left;">SPV PIC Asset</td>
                            </tr>
                            <tr>
                                <!-- <td style="border: 1px solid white">&nbsp;</td> -->
                    ...
                    <div class="col-xs-12">
                        <table border="1" style="width: 100%; margin-top: 20px;">
                            ...
                            <tr>
                                ...
                                <td class="text-center" rowspan="2" style="font-weight: bold;">ASSET NAME</td>
                            ...
                            <tr>
                                <td class="text-center">ASSET NUMBER</td>
                                <td class="text-center">ASSET ID</td>
                                <td class="text-center">BC IN</td>
                            ...
                            <tr>
                                <td>TOTAL</td>
                                <td class="text-center" colspan="11">88</td>
                            </tr>
