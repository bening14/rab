        ...
        $("#tableScrap").DataTable({
            ...
            'columns': [{
                ...
                "render": function(data) {
                    return data.username + `<br>` + data.section
                }
            }, {
                "target": [<?= $target++ ?>],
                "className": 'text-center py-1',
                "data": "data",
                "render": function(data) {
                    if (data.kategori == 'NOBC') {
                        return `<small class="label label-info"> NO BC</small>`
                    } else if (data.kategori == 'BC') {
                        return `<small class="label label-danger"> BC</small>`
                    } else {
                ...
                "render": function(data) {
                    if (data.b3 == 'NON B3') {
                        return `<small class="label label-info"> NON B3</small>`
                    } else if (data.b3 == 'B3') {

                        if (user == 'PGA') {
                            return `<small class="label label-danger"> B3</small><br>UPLOAD`
                        } else {
                            return `<small class="label label-danger"> B3</small><br>TAMPILKAN FILE`
                        }
                ...
                "data": "data",
                "render": function(data) {
                    return `Form Pengajuan<br><a href="<?= base_url('user/dunlud_pengajuan/') ?>` + data.file_location + `"><img src="<?= base_url('assets/adminlte/dist/img/pdf.png') ?>" alt="pdf" width="32" height="32" style="margin-top: 5px;"></a>`
                }
            }, {
                "target": [<?= $target++ ?>],
                "className": 'text-center py-1',
                ...
                "render": function(data) {
                    if (data.evidence == '') {
                        if (user == 'EXIM' || user == 'PGA') {
                            button_doc = `-`
                        } else {
                            button_doc = `<ul style="padding-left: 20px;">
                                                <li>Dokumen Evidence<br><button class="btn btn-default btn-sm waves-effect waves-float waves-light ms-3px" onclick="uploadevidence('` + data.nomor_tiket + `')"> Upload</button></li>
                                        </ul>`
                        }
                    } else {
                        button_doc = `
                        <ul style="padding-left: 20px;">
                                            <li>Dokumen Evidence<br><a href="<?= base_url('user/dunlud_evidence/') ?>` + data.evidence + `"><img src="<?= base_url('assets/adminlte/dist/img/pdf.png') ?>" alt="pdf" width="32" height="32" style="margin-top: 5px;"></a> <button class="label pull-right bg-red" onclick="hapus_evidence('` + data.nomor_tiket + `')"><i class="fa fa-trash"></i></button></li>
                                    </ul>`
                    }
                ...
                "render": function(data) {
                    if (user == 'EXIM') {
                        if (data.status_approval == 'OPEN') {
                            return `<button class="btn btn-sm btn-info" onclick="modalapproval('APPROVE','` + data.nomor_tiket + `')"><i class="fa fa-thumbs-up"></i> NO BC</button>&nbsp;<button class="btn btn-sm btn-danger" onclick="modalapproval('REJECT','` + data.nomor_tiket + `')"><i class="fa fa-thumbs-down"></i> BC</button>`
                        } else {
                            return `-`
                        }
                    } else if (user == 'PGA') {
                        if (data.b3 == 'OPEN') {
                            return `<button class="btn btn-sm btn-info" onclick="modalapproval('NON B3','` + data.nomor_tiket + `')"><i class="fa fa-thumbs-up"></i> NON B3</button>&nbsp;<button class="btn btn-sm btn-danger" onclick="modalapproval('B3','` + data.nomor_tiket + `')"><i class="fa fa-thumbs-down"></i> B3</button>`
                        } else {
                            return `-`
                        }
                    ...
                    // if (data.status_approval == 'OPEN') {
                    //     if (user == 'EXIM') {
                    //         return `<button class="btn btn-sm btn-info" onclick="modalapproval('APPROVE','` + data.nomor_tiket + `')"><i class="fa fa-thumbs-up"></i> Approve</button>&nbsp;<button class="btn btn-sm btn-danger" onclick="modalapproval('REJECT','` + data.nomor_tiket + `')"><i class="fa fa-thumbs-down"></i> Reject</button>`
                    //     } else {
                    //         return `<small class="label label-info"> OPEN</small>`
                    //     }
                    // } else if (data.status_approval == 'REJECT') {
                    //     return `<small class="label label-danger"> REJECT</small>`
                    // } else if (data.status_approval == 'APPROVE') {
                    //     return `<small class="label label-success"> APPROVE</small>`
                    // }
                }
            }, ],
