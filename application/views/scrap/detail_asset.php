...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="callout callout-success">
            <h1><strong>MOHON PERHATIAN</strong></h1>
                        ...
                        <table id="tableScrap" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>KODE BARANG</th>
                                    <th>YBM CODE</th>
                                    <th>NAMA BARANG USER</th>
                                    <th>NAMA BARANG FA</th>
                                    <?php
...
<script>
    ...
    $(function() {
        if (user == 'EXIM') {
            $("#tableScrap").DataTable({
                ...
                'columns': [{
                    ...
                    },
                    {
                        ...
                        "data": "data",
                        "render": function(data) {
                            return `<input type="text" class="form-control" name="invoice_po_invoice" id="invoice_po_invoice${data.id}" placeholder="INVOICE" style="width: 100px;" value="${data.invoice_po_invoice}" onfocusout="update_kolom('${data.id}','invoice_po_invoice','${data.tiket_no}')">`
                        }
                    },
                    {
                        "target": [<?= $target ?>],
                    ...
                    },
                    {
                        ...
                        "render": function(data) {
                            if (data.kategori_harga == '') {
                                return `<select class="form-control" id="data_harga" onchange="ubah_kategori('` + data.id + `')">
            ...
            $("#tableScrap").DataTable({
                ...
                'columns': [{
                        ...
                        "data": "data",
                        "render": function(data) {
                            return `<input type="text" class="form-control" name="asset_number" id="asset_number${data.id}" placeholder="Asset Number" style="width: 100px;" value="${data.asset_number}" onfocusout="update_kolom('${data.id}','asset_number','${data.tiket_no}')">`
                        }
                    }, {
                        "target": [<?= $target ?>],
                        "className": 'text-center py-1',
                        ...
                        "data": "data",
                        "render": function(data) {
                            return `<input type="text" class="form-control" name="id_asset" id="id_asset${data.id}" placeholder="ID Asset" style="width: 100px;" value="${data.id_asset}" onfocusout="update_kolom('${data.id}','id_asset','${data.tiket_no}')">`
                        }
                    }, {
                        "target": [<?= $target ?>],
                        "className": 'text-center py-1',
                        ...
                        "data": "data",
                        "render": function(data) {
                            // return `<input type="date" class="form-control" name="acquisition_date" id="acquisition_date${data.id}" style="width: 100px;" value="${data.acquisition_date}" onkeyup="update_kolom('${data.id}','acquisition_date','${data.acquisition_date}')">`
                            return `<input type="date" class="form-control" name="acquisition_date" id="acquisition_date${data.id}" placeholder="ACQUISITION DATE" style="width: 150px;" value="${data.acquisition_date}" onfocusout="update_kolom('${data.id}','acquisition_date','${data.tiket_no}')">`
                        }
                    }, {
                        "target": [<?= $target ?>],
                        "className": 'text-center py-1',
                        ...
                        "data": "data",
                        "render": function(data) {
                            return `<input type="text" class="form-control" name="book_value" id="book_value${data.id}" placeholder="Book Value" style="width: 100px;" value="${data.book_value}" onfocusout="update_kolom('${data.id}','book_value','${data.tiket_no}')">`
                        }
                    }, {
                        "target": [<?= $target ?>],
                        "className": 'text-center py-1',
                        ...
                        "data": "data",
                        "render": function(data) {
                            return `<input type="text" class="form-control" name="nama_barang_fa" id="nama_barang_fa${data.id}" placeholder="Nama Barang FA" style="width: 300px;" value="${data.nama_barang_fa}" onfocusout="update_kolom('${data.id}','nama_barang_fa','${data.tiket_no}')">`
                        }
                    }, {
                        "target": [<?= $target ?>],
                        "className": 'text-center py-1',
        ...
        // <a href="#" type="button" class="btn bg-green"><i class="fa fa-file-excel-o"></i> Download Excel</a>
