...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="callout callout-success">
            ...
            <p>! Input harga berdasarkan harga pasar di area kerja perusahaan</p>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><strong>HARGA MATERIAL</strong></h3>
...
<script>
    ...
    $(function() {
        ...
        $("#tableHarga").DataTable({
            ...
            'ajax': {
                'dataType': 'json',
                'url': '<?= base_url('user/ajax_table_harga_material') ?>',
                'type': 'post',
            },
            'columns': [{
                "target": [<?= $target ?>],
    ...
    $("#form_update_harga").submit(function(e) {
        ...
        form_data.append('table', 'tbl_harga_material');
    ...
    $("#form_tambah_harga").submit(function(e) {
        ...
        if ($('#kode_barang').val() == '' || $('#harga').val() == '' || $('#kab_kota').val() == '') {
            Swal.fire(
                'error!',
                'tidak boleh ada kolom kosong!',
                'error'
        ...
        // process_submit()
        var url_ajax = '<?= base_url() ?>user/tambah_harga_material'

        var id_mst_barang = $('#id_mst_barang').val();
        var harga = $('#harga').val();
        var id_mst_lokasi = $('#id_mst_lokasi').val();
        var form_data = new FormData();
        form_data.append('table', 'tbl_harga_material');
        form_data.append('id_mst_barang', id_mst_barang);
        form_data.append('harga', harga);
